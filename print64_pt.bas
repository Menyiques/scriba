...
SUB print64 (characters$ as String)
    ...
    p64_charset:
            ...
            DEFB 36,0,102,17,51,85,51,0   ; a_ag a_gr
            DEFB 101,0,102,17,51,85,51,0   ; a_cf a_til
            DEFB 2,0,2,37,86,68,83,32   ; c_ced e_ag
            DEFB 98,2,32,86,98,66,55,0   ; e_cf i_ag
            DEFB 38,0,34,85,85,85,34,0   ; o_ag o_cf
            DEFB 82,0,37,85,85,85,34,0   ; o_til u_ag
            DEFB 34,39,84,118,84,84,87,0   ; A_ag E_ag
            DEFB 80,0,82,117,84,84,85,2   ; A_til C_ced
LOCAL p64_END
    p64_END:
    ENDP
    end asm
