...
SUB print64 (characters$ as String)
    ...
    p64_charset:
            ...
            DEFB 0,0,0,0,0,0,0,0   ; relleno code 128/129
            DEFB 0,0,0,0,0,0,0,0   ; relleno code 130/131
            DEFB 0,0,0,0,0,0,0,0   ; relleno code 132/133
            DEFB 0,0,0,0,0,0,0,0   ; relleno code 134/135
            DEFB 0,0,0,0,0,0,0,0   ; relleno code 136/137
            DEFB 0,0,0,0,0,0,0,0   ; relleno code 138/139
            DEFB 0,0,0,0,0,0,0,0   ; relleno code 140/141
            DEFB 0,0,0,0,0,0,0,0   ; relleno code 142/143
            DEFB 34,0,98,21,54,84,51,0   ; a_ac e_ac
            DEFB 34,32,2,101,37,37,114,0   ; i_ac o_ac
            DEFB 46,0,86,85,85,85,37,0   ; u_ac n_til
            DEFB 164,0,84,88,94,80,32,0   ; u_die inv_q
            DEFB 66,2,69,71,69,69,69,0   ; inv_e A_ac
            DEFB 34,119,66,98,66,66,119,0   ; E_ac I_ac
            DEFB 34,37,85,85,85,85,34,0   ; O_ac U_ac
            DEFB 234,85,85,117,117,85,82,0   ; N_til U_die
LOCAL p64_END
    p64_END:
    ENDP
    end asm
